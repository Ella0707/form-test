...
// let buttonForm = document.querySelector(".registration__btn");
// let out = document.querySelector(".registration__warning");


// buttonForm.onclick = function() {
//         valueInput = (inputINN.value);
//         // console.log (valueInput)
//         if (inputINN = "111") {
//             out.innerHTML = ('Ваша компания уже зарегистрирована, пожалуйста обратитесь&nbsp;к менеджеру вашего аккаунта или' );
//             // document.body.append(el);
//             // inputINN.setAttribute("novalidate");
//             buttonForm.setAttribute("disabled", "disabled");

//         }
//     //    else {
//     //     inputINN = "";
//     //     buttonForm.setAttribute("defoult", "defoult");
